...
urlpatterns = [
    ...
    url(r'^auth/get$', views.getAuth, name="get_auth"),
    url(r'^auths$', views.authView, name="get_all_auth"),

    # url(r'^recommendations/$', views.recommendations, name="recommendations"),
    url(r'^recommendations/retrieve/(?P<pk>[0-9]+)$', views.retrieve_recommendations, name="retrieve_recommendations"),
    url(r'^recommendations/create$', views.create_recommendations, name="create_recommendations"),
    url(r'^recommendations/delete$', views.delete_recommendations, name="delete_recommendations"),
